import type { SerializedTreeItem } from './DbObjectService';
...
let payload: SerializedTreeItem[] | null = null;
let stashedAt = 0;

export function setLastTreeDragPayload(items: SerializedTreeItem[]): void {
  payload = items;
  stashedAt = Date.now();
}

export function getLastTreeDragPayload(): SerializedTreeItem[] | null {
